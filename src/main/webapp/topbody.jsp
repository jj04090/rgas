				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="order-lg-2 col-auto px-0 mr-lg-0">
							<a href="index.html" class="standard-logo" data-dark-logo="images/logo-rgas.jpg"><img src="images/logo-rgas.jpg" alt="Canvas Logo" style="height: 100px;"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="images/logo-rgas.jpg"><img src="images/logo-rgas.jpg" alt="Canvas Logo" style="height: 100px;"></a>
						</div><!-- #logo end -->
