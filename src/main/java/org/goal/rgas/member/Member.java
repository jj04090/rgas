...
public class Member implements Serializable {
    ...
    public Member(int no, String email, String password, String name, String nickname, String bank, String account, char grade, char auth, char status, int itemStart, int itemSizePerPage) {
        this.no = no;
        this.email = email;
