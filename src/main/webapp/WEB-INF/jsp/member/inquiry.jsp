                                    ...
                                    <div class="card-content" style="padding-bottom:20px;">
                                        <form>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <i class="material-icons prefix">account_circle</i>
                                                    <input type="text" id="nickname" name="nickname" value="${member.nickname}" style="color:black;" disabled>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    ...
                                                    <input type="text" id="bank" name="bank" value="${bankName}" style="color:black;" disabled>
                                                    <label style="font-size:20px;font-weight:bold;">은행</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <i class="material-icons prefix">local_atm</i>
                                                    <input type="text" id="account" name="account" value="${member.account}" style="color:black;" disabled>
